    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('user', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='MApi.user')),
            ],
        ),
        migrations.CreateModel(
            name='Transactions',
            fields=[
                ...
                ('wallet', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MApi.wallet')),
            ],
        ),
    ]
